# Plano de Exploração — Body-Harmony-Remake
...
- [x] **Archaeologist** — Análise do módulo `auth` + `aluna` + `licenciada`
- [x] **Archaeologist** — Análise do módulo `admin` (Core, Controllers, admin/)
- [x] **Archaeologist** — Análise do módulo `lms` + `content` + `certificate`
- [x] **Archaeologist** — Análise do módulo `nexus` (Nexus, Analytics, Broadcast, Media)
- [x] **Archaeologist** — Análise do módulo `doctor-harmony` + `leads`
- [x] **Archaeologist** — Análise do módulo `frontend` (structure, components, pages)
...
- [x] **Revisor** — Resolução de lacunas com o usuário (responda o questions.md)
