...
### Creative & Design (Body Harmony Luxury Design System)
Skills for visual design, UI/UX, and luxury web engineering:
- `@bodyharmony-frontend-luxury` - **Skill Mestra Oficial:** Design System Luxury (Navy `#0A3E60` / Gold `#ED7E13`), Mobile-First (touch >=44px), Zero Whitespace Waste, Ergonomia <=800px, React 18 e Lucide-React.
- `@smartbook-clinical-generator` - Arsenal Clínico de Cabine & Benchmark NotebookLM MCP (SmartBook Studio).
- `@bodyharmony-humanizer` - Adequação ao tom e voz institucional Body Harmony.
